...
from task_1 import get_best_alltime, get_raw_input
...
def get_best_actors(actors_raw_df, top_100_actors):
    ...
    best_actors = top_100_actors.join(actors_raw_df, top_100_actors['tconst'] == actors_raw_df['tconst'])
...
def main():
    ...
    best_ac = get_best_actors(actors_raw_df, get_best_alltime(*get_raw_input()))
